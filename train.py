...
def get_args():
    ...
    parser.add_argument('--use_sam', action='store_true', help='use SAM pseudo masks as an extra input channel')
    parser.add_argument('--sam_mask_dir', type=str, default='sam_pseudo_masks', help='directory for SAM pseudo masks')
...
in_channels = 4 if opts.use_sam else 3
#model and optimizer
model = UneXt50(in_channels=in_channels).cuda()
