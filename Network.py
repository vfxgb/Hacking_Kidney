...
class ConvLayer(nn.Sequential):
    def __init__(self, ni, nf, ks=3, stride=1, padding=None, norm_type=None, act_cls=nn.LeakyReLU, leaky=0.1, xtra=None):
...
class PixelShuffle_ICNR(nn.Sequential):
    def __init__(self, ni, nf=None, scale=2, blur=False, leaky=None):
        ...
        self.add_module("shuffle", nn.Sequential(*layers))
